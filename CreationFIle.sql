...
isfullstatus varchar(3) not null,
...
insert into reservation(reservationid, spotsreserved, customerid, tripid)
values(00001,2,11111,11111);
insert into reservation(reservationid, spotsreserved, customerid, tripid)
values(00002,1,11112,11111);
insert into reservation(reservationid, spotsreserved, customerid, tripid)
values(00003,4,11111,11114);
insert into reservation(reservationid, spotsreserved, customerid, tripid)
values(00004,1,11114,11113);

-- add into trip table
insert into trip(tripid, tripname, tripdate, tripstatus, starttime, tripdescription, maxcapacity, numenrolled, isfullstatus, distancemiles, lengthhours, tripprice, street, city, state, zip, empid)
values(11111,"Birmingham trip","2026-07-25","Incomplete","8:30:00","Day trip to Birmingham",25,3,"Yes",50,6,550.67, "2100 Richard Arrington JR BLVD" ,"Birmingham","AL","35203",11111);
insert into trip(tripid, tripname, tripdate, tripstatus, starttime, tripdescription, maxcapacity, numenrolled, isfullstatus, distancemiles, lengthhours, tripprice, street, city, state, zip, empid)
values(11112,"Museum Trip","2023-05-11","Incomplete","10:30:00","Trip to local museums",15,0,"No",10,6,65.00,"University BLVD","Tuscaloosa","AL","35401",11112);
insert into trip(tripid, tripname, tripdate, tripstatus, starttime, tripdescription, maxcapacity, numenrolled, isfullstatus, distancemiles, lengthhours, tripprice, street, city, state, zip, empid)
values(11113,"Trip C","2027-12-31","Incomplete","12:00:00","A placeholder trip",25,0,"No",0,0,0,"Placeholder","Tuscaloosa","AL","35401",11112);
insert into trip(tripid, tripname, tripdate, tripstatus, starttime, tripdescription, maxcapacity, numenrolled, isfullstatus, distancemiles, lengthhours, tripprice, street, city, state, zip, empid)
values(11114,"Aquarium Trip","2026-06-05","Incomplete","08:00:00","Day trip to aquarium",20,4,"No",508,12,225.00,"2100 E Beach BLVD","Gulfport","MS","39501",11114);
